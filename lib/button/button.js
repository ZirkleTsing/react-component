...
export default class Button extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (typeof currentLoading !== 'boolean' && currentLoading && currentLoading.delay) {
      this.delayTimeout = window.setTimeout(() => this.setState({ currentLoading }), currentLoading.delay)
    } else {
      this.setState({
