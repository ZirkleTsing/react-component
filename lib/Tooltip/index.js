...
class Popover extends React.Component {
  ...
  render () {
    const { overlayClassName, title, style, placement, prefixCls, onMouseEnter, onMouseLeave } = this.props
    ...
    return (
      <Animate
        ...
        component=''
      >
        <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} style={style} className={classes}>
          {title}
        </div>
      </Animate>
    )
